...
{
  py::class_<GateDoseActor, PyGateDoseActor, std::unique_ptr<GateDoseActor, py::nodelete>, GateVActor>(m, "GateDoseActor")
      .def(py::init<py::dict &>())
      .def("InitializeUserInfo", &GateDoseActor::InitializeUserInfo)
      .def("BeginOfRunActionMasterThread", &GateDoseActor::BeginOfRunActionMasterThread)
      .def("EndOfRunActionMasterThread", &GateDoseActor::EndOfRunActionMasterThread)
