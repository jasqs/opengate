...
{
     py::class_<GateWeightedEdepActor, PyGateWeightedEdepActor, std::unique_ptr<GateWeightedEdepActor, py::nodelete>, GateVActor>(m, "GateWeightedEdepActor")
         .def(py::init<py::dict &>())
         .def("BeginOfRunActionMasterThread", &GateWeightedEdepActor::BeginOfRunActionMasterThread)
         .def("EndOfRunActionMasterThread", &GateWeightedEdepActor::EndOfRunActionMasterThread)
         ...
         .def_readwrite("cpp_denominator_image", &GateWeightedEdepActor::cpp_denominator_image)
